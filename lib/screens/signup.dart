                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text('Personal Information',style: TextStyle(color: Colors.lightBlueAccent,fontWeight: FontWeight.bold,fontSize: 20),),
                              Gaps.gap16,
                              TextInput(
                                hint: 'email',
                                    ...
                                    child: Column(
                                      children: [
                                        MaterialButton(
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(color: _ismale?Colors.amberAccent:Colors.grey,borderRadius: BorderRadius.circular(250)),
                                            child: Image.asset('images/male.png',),
                                          ),
                                        ),
                                        Gaps.gap4,
                                        Text('Male',style: TextStyle(color:_ismale?Colors.amberAccent:Colors.grey,fontSize: 25),)
                                      ],
                                    ),
                                  ),
                                  Expanded(
                                    child: Column(
                                      children: [
                                        MaterialButton(
                                          ...
                                          child: Container(
                                            decoration: BoxDecoration(color: _ismale?Colors.grey:Colors.amberAccent,borderRadius: BorderRadius.circular(250)),
                                            child: Image.asset('images/female.png',),
                                          ),
                                        ),
                                        Gaps.gap4,
                                        Text('Female',style: TextStyle(color:_ismale?Colors.grey:Colors.amberAccent,fontSize: 25),)
                                      ],
                                    ),
                                  ),
                                ],
                              ...
                              Gaps.gap12,
                              Text('student picture :',style: TextStyle(color: Colors.white,),),
                              Gaps.gap8,
                              Row(
                              ...
                              Gaps.gap24,
                              Text('parents information',style: TextStyle(color: Colors.lightBlueAccent,fontWeight: FontWeight.bold,fontSize: 20),),
                              Gaps.gap16,
                              TextInput(
                                hint: 'parent\'s job',
                                validator: (String? name) {
                                ...
                                inputType: TextInputType.name,
                                onChanged: (name){_parentJop=name!;},
                                ...
                                children: [
                                  Expanded(
                                    child: TextInput(
                                      ...
                                      inputType: TextInputType.number,
                                      onChanged: (name){_fatherPhone=name!;},
                                  ...
                                  Expanded(
                                    child: TextInput(
                                      ...
                                      inputType: TextInputType.number,
                                      onChanged: (name){_motherPhone=name!;},
                              ...
                              Gaps.gap24,
                              Text('Education information',style: TextStyle(color: Colors.lightBlueAccent,fontWeight: FontWeight.bold,fontSize: 20),),
                              Gaps.gap12,
                              TextInput(
                                hint: 'School name',
                                validator: (String? name) {
                                ...
                                inputType: TextInputType.name,
                                onChanged: (name){_school=name!;},

                              ),//school
                              Gaps.gap12,
                              Text('Government :',style: TextStyle(color: Colors.white),),
                              Gaps.gap8,
                              Container(
                            ...
                            child: Text(items,style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold),),
                            );}).toList(),
                                ...
                                child: DropdownButton(
                                  ...
                                  items: _gradeList.map((String item) {
                                    return DropdownMenuItem(value: item,
                                      ...
                                      child: Text(item,style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold),),
                                    );}).toList(),
                                  onChanged: (String? newValue) {
                                    setState(() {
                                      _grade = newValue!;
                                      ...
                                      children: [
                                        MaterialButton(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(color: _isonsite?Colors.green:Colors.grey,borderRadius: BorderRadius.circular(250)),
                                            child: Image.asset('images/on-site.png',),
                                          ),
                                        ),
                                        Gaps.gap4,
                                        Text('Center',style: TextStyle(color:_isonsite?Colors.green:Colors.grey,fontSize: 25),)
                                      ],
                                    ),
                                  ),
                                  Expanded(
                                    child: Column(
                                      children: [
                                        MaterialButton(
                                          ...
                                          child: Container(
                                            constraints: BoxConstraints(maxWidth: 150),
                                            decoration: BoxDecoration(color: _isonsite?Colors.grey:Colors.green,borderRadius: BorderRadius.circular(250)),
                                            child: Image.asset('images/online.png',),
                                          ),
                                        ),
                                        Gaps.gap4,
                                        Text('Online',style: TextStyle(color:_isonsite?Colors.grey:Colors.green,fontSize: 25),)
                                      ],
                                    ),
                                  ),
                                ],
    ...
    if (formState != null) {
      if (formState.validate()) {
        ...
        if(Platform.isAndroid)
          UserID.userdata['UIDV']=deviceInfo.data['id'];
        if(Platform.isIOS)
  ...
  static Future<User?> signUpUsingEmailPassword({
    ...
    try {
      ...
      if (e.code == 'weak-password') {
        ...
        ShowToast('The account already exists for that email.', ToastGravity.TOP);
    ...
    if(user!=null)
      await FirebaseFirestore.instance.collection("userData").doc('${user?.uid}').set(UserID.userdata).onError((e, _) => print("Error writing document: $e"));
    return user;
  }
